...
export default function Pokemon({pokemon,searchState}:any) {
  // console.log(pokemon);

  const pokemonId:any = pokemon.data.id;
                      ...
                      <div className="row">
                          ...
                          <div className="col-md-6">
                              <div className="product p-4">
                                  ...
                                  <span onClick={goBack} className="text-lg no-underline text-grey-darkest hover:text-blue-dark cursor-pointer transition-colors duration-200 transform bg-red-600 rounded-md hover:bg-red-400 focus:outline-none focus:bg-red-400 text-white px-2">Go back</span>
